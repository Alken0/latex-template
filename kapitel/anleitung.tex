...
\begin{figure}[H]
	\centering
	\subfigure[Bezeichnung der linken Grafik]{\includegraphics[width=2cm]{kapitel/offizielles/img/cas}}
	\hspace{1em} % space between images
	\subfigure[Bezeichnung der rechten Grafik]{\includegraphics[width=2cm]{kapitel/offizielles/img/cas}}
